...
svm_txt="mp2-q1-q15-g10-svm.txt"
gop=10
compress_number=8
...
do
    ...
    for((i=1;i<=15;i++))
    do
        python /home/cjy/cuda-workspace/ffmpeg/enc-dec.py -v $video -n $compress_number -gop $gop -r $result_folder -q $i -yuv $yuv_folder
...
python /home/cjy/cuda-workspace/ffmpeg/generatefeature.py -data $result_folder/data.txt -qend 15  > $result_folder/$svm_txt
